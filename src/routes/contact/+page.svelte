<script>
	...
	function goToMap() {
		if (
			...
			window.open('google.navigation:q=52.905888,6.289712&mode=d', '_system');
		} else if (
			navigator.userAgent.match(/iPhone/i) ||
			navigator.userAgent.match(/iPad/i) ||
			navigator.userAgent.match(/iPod/i)
		) {
			window.open('https://maps.apple.com/?daddr=52.905888,6.289712&ll=', '_system');
		} else {
			window.open('https://maps.google.com/maps?daddr=52.905888,6.289712&ll=', '_system');
		}
	}
</script>
...
<svelte:head>
	...
	<meta
		...
		content="Marion Plagge, Wateren 10, 8438 SB Wateren, 06-1120 1579, info@marionplagge.nl"
	/>
	<meta
		name="description"
		content="Marion Plagge, Wateren 10, 8438 SB Wateren, 06-1120 1579, info@marionplagge.nl"
...
<div id="wsite-content" class="wsite-elements wsite-not-footer">
	<div class="wsite-section-wrap">
		<div
			class="wsite-section wsite-body-section wsite-section-bg-image wsite-background-3 wsite-custom-background"
		>
			<div class="wsite-section-content">
				<div class="container">
					<div class="wsite-section-elements">
                        ...
                        "
									>
										<a aria-label="Chat on WhatsApp" href="https://wa.me/31611201579">
											<button
												type="button"
                            ...
                            "
											>
												...
												>
													...
													></path>
												</svg> Chat on What's App
											</button>
										</a>

										<a href="https://t.me/+31611201579">
											<button
												type="button"
												class="btn btn-primary"
												style="
